          ...
          <div className="container mx-auto mt-20 h-full w-full ">
            <Card placeholder="" className="mt-6 w-full pb-20 text-black">
              <CardBody placeholder="" className="m-10">
                <Typography placeholder="" variant="h1">Privacy Policy</Typography>
                <Typography placeholder="" variant="h4" className="mt-10">Table of Contents</Typography>
                <span>
                  <ol className="list-decimal pl-5 underline">
                    <li className="cursor-pointer my-5">
                      <Link to="1" offset={-120} smooth="true" >Interpretation and Definitions</Link>
                    </li>
                    <li className="cursor-pointer my-5">
                      <Link to="2" offset={-120} smooth="true" >Collecting and Using Your Personal Data</Link>
                    </li>
                    <li className="cursor-pointer my-5">
                      <Link to="3" offset={-120} smooth="true" >Use of Your Personal Data</Link>
                    </li>
                    <li className="cursor-pointer my-5">
                      <Link to="4" offset={-120} smooth="true" >Retention of Your Personal Data</Link>
                    </li>
                    <li className="cursor-pointer my-5">
                      <Link to="5" offset={-120} smooth="true" >Transfer of Your Personal Data</Link>
                    </li>
                    <li className="cursor-pointer my-5">
                      <Link to="6" offset={-120} smooth="true" >Delete Your Personal Data</Link>
                    </li>
                    <li className="cursor-pointer my-5">
                      <Link to="7" offset={-120} smooth="true" >Disclosure of Your Personal Data</Link>
                    </li>
                    <li className="cursor-pointer my-5">
                    ...
                    <li className="cursor-pointer my-5">
                      <Link to="11" offset={-120} smooth="true" >Changes to this Privacy Policy</Link>
                    </li>
                    <li className="cursor-pointer my-5">
                      <Link to="12" offset={-120} smooth="true" >Contact Us</Link>
                    </li>
                  </ol>
                </span>

                <Typography placeholder="" variant="h2" className="mt-5"> <Element name="1" className="element">Interpretation and Definitions</Element></Typography>
                <Typography placeholder="" variant="h3" className="mt-5">Interpretation</Typography>
                <Typography placeholder="" className="mt-5" variant="paragraph">
                  The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</Typography>
                <Typography placeholder="" variant="h3" className="mt-5">Definitions</Typography>
                <Typography placeholder="" className="mt-5" variant="paragraph">
                ...
                <Typography placeholder="" variant="h2" className="mt-5"><Element name="2" className="element">Collecting and Using Your Personal Data</Element></Typography>
                <Typography placeholder="" variant="h3" className="mt-5">Types of Data Collected </Typography>
                <Typography placeholder="" variant="h4" className="mt-5">Personal Data </Typography>
                ...
                <Typography placeholder="" variant="h4" className="mt-5">Information from Third-Party Social Media Services</Typography>
                <Typography placeholder="" className="mt-2" variant="paragraph">
                  The Company allows You to create an account and log in to use the Service through the following Third-party Social Media Services:<br /></Typography>
                <ol className="list-disc mt-5 pl-5">
                  <li>Google</li>
                  <li>Facebook</li>
                  <li>Instagram</li>
                ...
                <Typography placeholder="" variant="h3" className="mt-5"><Element name="4" className="element">Retention of Your Personal Data</Element></Typography>
                <Typography placeholder="" className="mt-5" variant="paragraph">
                ...
                <Typography placeholder="" variant="h3" className="mt-5"><Element name="6" className="element">Delete Your Personal Data</Element></Typography>
                <Typography placeholder="" className="mt-5" variant="paragraph">
                ...
                <Typography placeholder="" variant="h3" className="mt-5"><Element name="7" className="element">Disclosure of Your Personal Data</Element></Typography>
                <Typography placeholder="" variant="h4" className="mt-5">Business Transactions</Typography>
                <Typography placeholder="" className="mt-2" variant="paragraph">
                  If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</Typography>
                <Typography placeholder="" variant="h4" className="mt-5">Law enforcement</Typography>
                <Typography placeholder="" className="mt-2" variant="paragraph">
                  Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</Typography>
                <Typography placeholder="" variant="h4" className="mt-5">Other legal requirements</Typography>
                <Typography placeholder="" className="mt-2" variant="paragraph">
                  The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</Typography>
                <ol className="list-disc mt-5 pl-5">
